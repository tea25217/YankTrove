...
const ja = {
  ...
  saveDirPlaceholderNoYankTrove: 'デフォルト: ダウンロード',
  createYankTroveFolder: '保存先の下に YankTrove フォルダを作成する',
  overwriteModeLabel: '既存ファイルがあるとき',
  overwriteModeOverwrite: '上書き',
  overwriteModeSkip: 'スキップ',
  overwriteModeAsk: '毎回選択',
  browseDir: '選択',
  openDir: '開く',
  dataSelect: '取得データ選択',
  ...
  optAudio: '音声のみ抽出 (MP3)',
  optCsv: '整形データ (CSV)',
  videoQualityLabel: '画質:',
  videoQualityBest: '最高',
  videoQuality2160: '2160p (4K)',
  videoQuality1440: '1440p',
...
const en: { [K in keyof typeof ja]: string } = {
  ...
  saveDirPlaceholderNoYankTrove: 'Default: Downloads',
  createYankTroveFolder: 'Create a YankTrove folder under the save location',
  overwriteModeLabel: 'When files already exist',
  overwriteModeOverwrite: 'Overwrite',
  overwriteModeSkip: 'Skip',
  overwriteModeAsk: 'Ask each time',
  browseDir: 'Browse',
  openDir: 'Open',
  ...
  videoQualityLabel: 'Quality:',
  videoQualityBest: 'Best',
  videoQuality2160: '2160p (4K)',
  videoQuality1440: '1440p',
  videoQuality1080: '1080p',
  videoQuality720: '720p',
